...
class CoreDataManager{
    ...
    func realmSerch(key:String,property:String,dataModel:Object.Type) -> String{
        ...
        let result = Base64codeFunc.textFromBase64String(results[0])
        return result
    }
    ...
    func PropertyDictionary(key:String,dataModel:Object.Type) -> NSDictionary{
        ...
        let spellCritical1 = Base64codeFunc.textFromBase64String(spellCritical[0])
        ...
        let hitPenetration1 = Base64codeFunc.textFromBase64String(hitPenetration[0])
        ...
        let spellPenetration1 = Base64codeFunc.textFromBase64String(spellPenetration[0])
        ...
        let hitRating1 = Base64codeFunc.textFromBase64String(hitRating[0])
        ...
        let spellHitRating1 = Base64codeFunc.textFromBase64String(spellHitRating[0])
        ...
        let criticalDamage1 = Base64codeFunc.textFromBase64String(criticalDamage[0])
        ...
        let spellCriticalDamage1 = Base64codeFunc.textFromBase64String(spellCriticalDamage[0])
        ...
        let dodge1 = Base64codeFunc.textFromBase64String(dodge[0])
        let dodge2 = Double(dodge1)
        cache.setValue(dodge2, forKey: "dodge")
        
        let strikeSpeed = data.valueForKey("strikeSpeed") as! [String]
        let strikeSpeed1 = Base64codeFunc.textFromBase64String(strikeSpeed[0])
        ...
        let shield1 = Base64codeFunc.textFromBase64String(shield[0])
        let shield2 = Double(shield1)
        cache.setValue(shield2, forKey: "shield")
        
        let powerRank = data.valueForKey("powerRank") as! [String]
        let powerRank1 = Base64codeFunc.textFromBase64String(powerRank[0])
